                ...
                <div className={styles.imageContainer}>
                    <Link href="/f_register">
                        <div className={styles.imageItem}>
                            <Image src="/img/register.png" alt="Registrar" width={500} height={500} className={styles.image} />
                            <p className={styles.imageText}>Registrar Fundación</p>
                        </div>
                    </Link>
                    <Link href="/f_login">
                        <div className={styles.imageItem}>
                            <Image src="/img/login.png" alt="Iniciar Sesión" width={500} height={500} className={styles.image} />
